    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 xl:gap-4 flex-shrink-0 relative z-[95]">
          ...
          >
            <span className="relative z-10">3D Experience</span>
              ...
              >
                <div className="flex flex-col gap-2">
                            ...
                            <div className="rounded-xl overflow-hidden">
                              ...
                              >
                                <div className="text-left">
                                  ...
                                  <h4 className="text-[13px] font-bold text-gray-700">Project Updates</h4>
                                </div>
                  ...
                  <motion.button
                    type="button"
                    whileTap={{ scale: 0.98 }}
                    onClick={() => { router.push('/3d-map'); setIsMobileMenuOpen(false); }}
