...
//   // State to track how many items to show for amenities
//   const [amenitiesCount, setAmenitiesCount] = useState(18);
...
//               Amenities
//             </h2>
//             {/* <div className="w-24 h-1 mt-2 mx-auto" style={{ backgroundColor: brandGreen }}></div> */}
//           </header>
...
//                 <div className="relative z-10 text-[#293659] group-hover:text-white transition-all duration-300 mb-4 group-hover:animate-bounce">
  ...
  return (
    <section className="relative py-20 px-4 overflow-hidden min-h-screen flex items-center">
      ...
      <div
        className="absolute inset-0 bg-fixed bg-cover bg-center"
        style={{
          backgroundImage: "linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.85)), url('/assets/blog/location.jpg')",
          backgroundAttachment: "fixed",
        }}
      ></div>
