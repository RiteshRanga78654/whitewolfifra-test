...
const amenities = [
  ...
  {
    name: "Modern Electrical Infrastructure",
    icon: <Zap className="w-6 h-6" />,
  },
  {
    name: "Underground Water Pipeline",
...
const neighbors = [
  {
    ...
    quote:
      "For me, the bigger developers had a problem with valuation, the smaller ones had poor infrastructure. I own a plot in Osiyan Habitat and it was true value for money.",
  },
  {
    plot: "94",
    name: "Nirmal Raj",
    ...
    <div className="border-b border-[#a54d21]/20">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <p className="pb-6 text-stone-600 leading-relaxed text-lg">
              {faq.a}
            </p>
          </motion.div>
        )}
...
const OsiyanHabitat = () => {
  ...
  const handleBrochureDownload = (e) => {
    ...
    link.href = "/assets/pdf/Osiyan_Habitat_Life_Style_Brochure_4.pdf";
  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #f7f3ed 0%, #faf8f5 50%, #f0ebd8 100%)",
        }}
      >
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 z-[120] w-full max-w-[95%] lg:max-w-6xl px-2">
            <div className="flex flex-wrap sm:flex-nowrap min-h-[90px] w-full items-center justify-center overflow-hidden shadow-2xl rounded-xl bg-white divide-y sm:divide-y-0 sm:divide-x divide-gray-200 border border-gray-100">
              <div className="flex-1 flex flex-col items-center justify-center py-5 px-4 hover:bg-gray-50 transition-colors w-1/2 sm:w-auto">
                <span className="font-Condensed font-bold text-3xl md:text-4xl text-gray-900 mb-1">
                  5.954{" "}
                  <span className="text-xl md:text-2xl text-stone-500">
                    Acres
                  </span>
                </span>
                <span className="text-[10px] md:text-[11px] font-bold tracking-[0.15em] uppercase text-[#a54d21]">
                  Land Area
                </span>
              </div>
              ...
              <div className="flex-[1.2] flex flex-col items-center justify-center py-5 px-4 hover:bg-gray-50 transition-colors w-1/2 sm:w-auto">
                <span className="font-Condensed font-bold text-xl md:text-2xl text-gray-900 mb-1 text-center">
                  HRERA-PKL-JJR-702-2025
                </span>
                <span className="text-[10px] md:text-[11px] font-bold tracking-[0.15em] uppercase text-[#a54d21]">
                  RERA ID
                </span>
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-xl md:text-2xl font-medium leading-relaxed text-stone-700">
                  Osiyan Habitat plots aren't just land parcels, they're your
                  ticket to a premium lifestyle township. Where your morning
                  coffee comes with peaceful surroundings and modern amenities.
                </p>
                <p className="text-lg md:text-xl leading-relaxed text-stone-600">
                  Secure Gated Community with Wide Roads, Landscaped Parks &
                  Green Spaces, Modern Electrical Infrastructure, and excellent
        ...
        <div className="relative group overflow-hidden h-[350px] md:h-[550px] w-full">
          ...
          >
            <h1 className="text-3xl md:text-6xl font-Condensed font-bold mb-6 text-white tracking-tight drop-shadow-2xl">
              Most Townships Give You a House.
              <br />
              <span className="text-[#c8a96b]">
                We Give You a Complete Lifestyle.
              </span>
            </h1>
          </motion.div>
        </div>
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-Condensed font-bold text-gray-900 mb-4">
              Project Highlights
            </h2>
            ...
            >
              <div className="space-y-6 mb-8">
                ...
                <p className="text-stone-600 text-lg md:text-xl leading-relaxed max-w-lg">
                  Hassle-free ownership with zero maintenance issues. DDJAY
                  approved project with transparent payment structures and high
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {whyInvest.slice(0, 4).map((item, idx) => (
                  <div
                    key={idx}
                    className="bg-white p-6 rounded-2xl shadow-sm border border-[#a54d21]/10"
                  >
                ...
                >
                  <div className="w-full max-w-xl bg-white rounded-3xl shadow-2xl p-8 md:p-12 relative border border-[#a54d21]/20">
                    ...
                    <p className="text-stone-500 text-sm md:text-base mb-10">
                      Enter your details to receive the digital brochure
                      instantly.
                    </p>
                    <form
                      className="space-y-8"
        ...
        <section className="relative py-20 md:py-25 px-6 md:px-16 overflow-hidden">
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-end">
              ...
              >
                <p className="text-stone-600 font-medium text-xl leading-relaxed">
                  A strategically located premium plotted development in Sector
                  27, Jhajjar. Featuring modern infrastructure, secure gated
                  community, and excellent connectivity.
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    {plotData.map((item, idx) => (
                      ...
                      >
                        <div className="flex flex-col">
                          ...
                          <span className="text-lg font-Condensed font-bold text-gray-900">
                            {item.plotNo}
                          </span>
                        </div>
                        <div className="flex flex-col">
                        ...
                        <div className="flex flex-col text-right">
                          <span className="text-[#a54d21] text-[9px] font-bold uppercase tracking-wider">
                            Facing
                          </span>
                          <span className="text-sm font-Condensed font-bold text-[#c8a96b]">
                            {item.facing}
                          </span>
                        </div>
                      </motion.div>
              ...
              <div className="lg:col-span-7 order-1 lg:order-2 relative">
                ...
                >
                  ...
                  <div
                    className="relative z-10 bg-[#faf8f5] border border-gray-200 p-4 shadow-2xl overflow-hidden rounded-3xl h-full flex flex-col cursor-pointer group"
                    onClick={() => window.open("/3d-map", "_blank")}
                  >
                    <div className="p-4 bg-gray-50 border-b border-gray-100 rounded-t-2xl flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-1.5 px-3 py-1 bg-[#faf8f5]/90 border border-[#e4ded5] backdrop-blur-md rounded-full shadow-sm">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-wider text-[#a54d21]">
                          Live Scanner
                        </span>
                      </div>
                    </div>
                    <div className="relative flex-1 bg-[#e3eae4] overflow-hidden group rounded-b-2xl flex items-center justify-center min-h-[400px]">
                      ...
                      <motion.div
                        ...
                        style={{
                          background:
                            "linear-gradient(90deg, transparent, rgba(165,77,33,0.8), transparent)",
                        }}
                        animate={{ top: ["0%", "100%", "0%"] }}
                        transition={{
                          duration: 6,
                  ...
                  <div className="absolute -bottom-6 -right-6 hidden md:flex flex-col bg-gradient-to-br from-[#a54d21] to-[#c8a96b] p-8 text-white shadow-2xl z-20 max-w-xs rounded-2xl">
                    ...
                    <a
                      href="/assets/pdf/Four_Fold_Digital.pdf"
                      download
                      className="inline-block px-6 py-3 bg-white text-[#a54d21] font-bold rounded-xl shadow-md hover:scale-105 transition-all text-sm"
                    >
                      Get HD PDF
                    </a>
                  </div>
            ...
            <div className="mt-20 mx-auto flex flex-wrap justify-center gap-12 border-t border-[#a54d21]/20 pt-16 text-center">
              {[
                { label: "Amenities", val: "25+" },
                { label: "Plot Units", val: "94" },
                { label: "Power Backup", val: "24/7" },
              ].map((stat, i) => (
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-white rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.15)] p-8 md:p-12 border border-gray-200">
                ...
                <form className="grid grid-cols-1 md:grid-cols-4 gap-8 items-end">
                  ...
                  <div>
                    <button
                      type="button"
                      onClick={() => window.open("/assets/pdf/Osiyan_Habitat_Life_Style_Brochure_4.pdf", "_blank")}
                      className="w-full py-4 bg-gradient-to-r from-[#a54d21] to-[#c8a96b] text-white font-bold rounded-xl tracking-widest text-sm hover:shadow-xl transition-all"
                    >
                      Secure Plot
                    </button>
                  </div>
            ...
            <div className="mt-20 md:mt-32 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
              ...
              >
                ...
                <p className="text-stone-600 font-medium text-xl leading-relaxed">
                  Perfectly positioned in Sector 27, Jhajjar, Osiyan Habitat
                  offers an exceptional opportunity to experience premium villa
                  plots with modern amenities in a rapidly developing growth
                  corridor.
                </p>
              </motion.div>
